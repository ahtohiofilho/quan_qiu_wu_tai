...
class Camera:
    ...
    def get_view_matrix(self):
        """Retorna a matriz de visualização (view)."""
    ...
    def resetar(self, fator: float):
        ...
        A câmera é colocada a 3× o raio do planeta do centro (~2× acima da superfície).
        """
        # Raio do planeta: fator / (2 * sin(π/5))
        raio_planeta = fator / (2 * glm.sin(glm.pi() / 5))

        # Distância do centro: 4× o raio do planeta
